...
const PAIR_INDEX_TO_DESCRIPTION: { [key in PairIndex]: string } = {
  ...
  [PairIndex.MOVEUSD]: "Movement to US Dollar",
  ...
  [PairIndex.RESOLVUSD]: "Resolv to US Dollar",
  [PairIndex.SQDUSD]: "Subsquid to US Dollar",
  [PairIndex.TAIKOUSD]: "Taiko to US Dollar",
  [PairIndex.HOMEUSD]: "Defi App to US Dollar",
  ...
  [PairIndex.RKLBUSD]: "Rocket Lab Corp to US Dollar",
  [PairIndex.ASTSUSD]: "AST SpaceMobile to US Dollar",
  [PairIndex.ARKXUSD]: "ARK Space & Defense Innovation ETF to US Dollar",
  [PairIndex.CCUSD]: "US Cocoa to US Dollar",
  [PairIndex.KCUSD]: "Coffee Arabica to US Dollar",
  [PairIndex.CTUSD]: "Cotton to US Dollar",
  [PairIndex.RBUSD]: "Gasoline to US Dollar",
  [PairIndex.NGUSD]: "Natural Gas to US Dollar",
  [PairIndex.ZSUSD]: "Soybean to US Dollar",
  [PairIndex.SBUSD]: "Sugar Raw to US Dollar",
  [PairIndex.ZWUSD]: "US Wheat to US Dollar",
  [PairIndex.UXUSD]: "Uranium to US Dollar",
  [PairIndex.GDXUSD]: "VanEck Gold Miners ETF to US Dollar",
  [PairIndex.SOYBEANUSD]: "Soybean2 to US Dollar",
  [PairIndex.USCOCOAUSD]: "US Cocoa2 to US Dollar",
  [PairIndex.CC1USD]: "US Cocoa3 to US Dollar",
};
