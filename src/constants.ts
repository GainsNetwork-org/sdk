...
// IMPORTANT: when modifying this list, make sure to update the sdk version
// of pricing monorepo!!!
export const corePairIndices = new Set([
  0, 1, 2, 3, 5, 7, 8, 11, 12, 13, 17, 18, 19, 20, 33, 35, 39, 40, 41, 44,
  47, 49, 50, 57, 90, 91, 102, 103, 104, 105, 107, 109, 129, 134, 137, 138,
  139, 140, 141, 142, 144, 145, 153, 155, 159, 168, 171, 188, 189, 190, 191,
  193, 205, 215, 216, 217, 219, 223, 269, 299, 307, 320, 321, 328, 331, 332,
  347, 358, 407, 413, 414, 418, 442,
]);
