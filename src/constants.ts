...
export const getAssetClassFromGroupIndex = (groupIndex: number): string | undefined => {
  switch (groupIndex) {
    case 0:
    case 10:
    case 11:
...
export const delistedPairIxs = new Set([
  4, 6, 15, 24, 25, 27, 28, 30, 31, 36, 48, 51, 52, 53, 54, 56, 59, 60, 61, 63, 66, 67, 68, 69, 70,
  71, 72, 73, 74, 75, 76, 77, 78, 79, 80, 95, 96, 97, 98, 99, 101, 106, 111, 113, 114, 116, 118,
  120, 122, 123, 125, 127, 130, 147, 152, 160, 163, 170, 179, 182, 183, 187, 188, 189, 190, 208,
  209, 225, 229, 230, 231, 238, 239, 241, 250, 253, 254, 258, 270, 275, 276, 278, 279, 282, 285,
  290, 294, 296, 305, 330, 349, 352, 353, 354, 355, 357, 365, 366, 377, 378, 379, 380, 382, 383,
  384, 385, 386, 387,
]);
